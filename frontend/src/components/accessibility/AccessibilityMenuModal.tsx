      ...
      <div className="bg-white text-slate-900 w-full max-w-2xl rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[92vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="bg-gradient-to-r from-indigo-950 via-indigo-900 to-indigo-950 text-white px-5 sm:px-6 py-4 flex items-center justify-between border-b border-indigo-800 flex-shrink-0">
          ...
          <button
            ...
            className="w-9 h-9 rounded-xl bg-indigo-900 hover:bg-indigo-800 text-slate-200 hover:text-white flex items-center justify-center transition border border-indigo-700"
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 transition hover:border-indigo-300">
            <div className="flex flex-wrap items-center justify-between gap-3 mb-3">
              ...
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-black transition flex items-center gap-1.5 shadow-sm ${
                  talkBackActive
            ...
            <div className="pt-3 border-t border-slate-200 flex flex-wrap items-center justify-between gap-3 text-xs">
              ...
              <button
                ...
                className="px-3 py-1 rounded-lg bg-indigo-50 hover:bg-indigo-100 text-indigo-800 font-bold border border-indigo-200 flex items-center gap-1"
              >
        ...
        {/* Footer Actions */}
        <div className="bg-slate-100 px-5 sm:px-6 py-3.5 border-t border-slate-200 flex items-center justify-between gap-3 flex-shrink-0">
          <button
          ...
          <button
            onClick={() => setIsA11yMenuOpen(false)}
            className="px-5 py-2 rounded-xl bg-indigo-950 hover:bg-indigo-900 text-white text-xs font-black transition shadow-md"
          >
